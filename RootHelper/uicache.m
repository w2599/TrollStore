...
void registerPath(NSString* path, BOOL unregister, BOOL system)
{
	...
	if(appBundleID && !unregister)
	{
		...
		NSArray* appBundleIDs = @[@"com.opa334.TrollStore", @"com.opa334.Dopamine", @"com.zqbb.Dopamine", @"com.xina.jailbreak", @"com.tigisoftware.Filza", @"com.opa334.Dopamine-roothide"];
